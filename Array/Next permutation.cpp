...
public:
    void nextPermutation(vector<int>& nums) {
      ...
      int n=nums.size();
       ...
       //  Step 1 // Traverse the array from second last element to the first.
for(int i = n - 2; i >= 0; i--) {
  ...
  //Step2      // If no such index found (i.e., the array is in descending order),
...
if(index == -1) {
   ...
   //step 3     // Find the rightmost element greater than the element at index.
